	...
	<div class='row'>
		...
		<div class='col-md-7 '>
			...
			<ul class='work_nav'>
				...
				<li><a href='#lambeth'>Mapping module for Lambeth Borough website</a></li>
			</ul>
			...
			<p>It scans blogs, forums, Facebook and Twitter for hyperlocal information. It tags and geolocates this data.</p>

			<p>It is providing a data source for both the 
			...
			<p>Heresay is my largest personal project and represents a significant amount of development time.</p>
			...
			<p><a href='bike-calculator.jimmytidey.co.uk'>Website</a></p>
		</div>
	</div>
</div>
